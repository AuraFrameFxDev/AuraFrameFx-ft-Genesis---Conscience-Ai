...
class ApiClient(
    ...
    companion object {
        @JvmStatic
        protected val baseUrlKey: String = "dev.aurakai.auraframefx.api.genesis.baseUrl"

        @JvmStatic
        val defaultBasePath: String by lazy {
            System.getProperties().getProperty(baseUrlKey, "https://api.genesis.aurakai.dev/v1")
        }
    }
}
